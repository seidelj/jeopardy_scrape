...
DATABASES['default'] = dj_database_url.config(default='postgres://postgres:joseph@localhost:5432/jeopardy')

#Honer the 'X-forward-proto' header for request.is_secure()
