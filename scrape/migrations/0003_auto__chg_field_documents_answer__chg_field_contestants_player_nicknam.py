...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Documents.answer'
        db.alter_column(u'scrape_documents', 'answer', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Contestants.player_nickname'
        db.alter_column(u'scrape_contestants', 'player_nickname', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Documents.answer'
        db.alter_column(u'scrape_documents', 'answer', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Contestants.player_nickname'
        db.alter_column(u'scrape_contestants', 'player_nickname', self.gf('django.db.models.fields.CharField')(max_length=128))
    ...
    models = {
        ...
        u'scrape.contestants': {
            ...
            'player_nickname': ('django.db.models.fields.CharField', [], {'max_length': '256'})
        },
        u'scrape.documents': {
